...
const AdminImmigrationLessons = lazyNamed(() => import('@/pages/admin/AdminImmigrationLessons'), 'AdminImmigrationLessons');
...
export const routes: RouteObject[] = [
...

  {
    ...
    children: [
      ...
      { path: 'immigration-lessons', element: <L><AdminImmigrationLessons /></L> },
