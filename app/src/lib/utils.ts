...
// Préfixes par cours (mig 032) :
//   AU/AC = Pflege (autonome/accompagné) · IU/IC = Immigration (autonome/accompagné)
export const ACTIVATION_CODE_REGEX = /^(AU|AC|IU|IC)-(?:\d{4}|[A-HJ-NP-Z2-9]{6})$/;
